...
namespace LV587SETOPENCART.Pages
{
    class PageWithProducts : ClassWithDriver
    {
        ...
        public IWebElement FirstProductName { get { return driver.FindElement(By.CssSelector(".caption h4 a[href*='/htc-touch-hd']")); } } //  PageTitle ("Wish List")
        public IWebElement SecondProductName { get { return driver.FindElement(By.CssSelector(".caption h4 a[href*='/iphone")); } } // Name of product in first row
